...
function savitzky_golay(x::Vector, windowSize::Integer, polyOrder::Integer; deriv::Integer=0)
#function savitzky_golay(x::Array, windowSize::Integer, polyOrder::Integer; deriv::Integer=0)
...
paddedX = [x[1]*ones(halfWindow); x; x[end]*ones(halfWindow)];           #--jcc
